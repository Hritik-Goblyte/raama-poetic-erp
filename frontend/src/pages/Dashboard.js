...
export default function Dashboard({ theme, setTheme }) {
  ...
  const fetchData = async () => {
    try {
      ...
      setRecentShayaris(shayarisRes.data.slice(0, 6));
    ...
    <div className="flex" style={{ background: 'var(--app-bg)', color: 'var(--app-text)' }}>
      ...
      <div className="lg:ml-64 flex-1 p-4 lg:p-8 min-h-screen pt-16 lg:pt-8 pb-20 lg:pb-8">
        ...
        <button
          ...
          className="lg:flex hidden fixed bottom-8 right-8 w-16 h-16 bg-orange-500 hover:bg-orange-600 text-white rounded-full shadow-2xl hover:shadow-orange-500/50 transition-all items-center justify-center z-40"
        >
          <Plus size={28} />
        </button>
      </div>
