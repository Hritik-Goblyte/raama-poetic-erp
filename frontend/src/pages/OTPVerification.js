        ...
        <div className="glass-card p-6 lg:p-8">
            ...
            <div className="flex gap-3 justify-center mb-4" onPaste={handlePaste}>
              {otp.map((digit, index) => (
                <input
                  ...
                  className="w-12 h-12 text-center text-xl font-bold bg-black/30 border border-gray-700 rounded-lg text-white focus:border-orange-500 focus:outline-none"
                />
              ))}
            </div>
          ...
          <div className="space-y-3">
            <button
              ...
              className="w-full py-3 bg-orange-500 hover:bg-orange-600 disabled:bg-gray-600 text-white font-semibold rounded-lg transition-all hover:shadow-lg hover:shadow-orange-500/50 flex items-center justify-center gap-2"
            >
              {loading ? (
                <>
            ...
            <button
              ...
              className="w-full py-3 bg-gray-700 hover:bg-gray-600 disabled:bg-gray-800 text-white font-semibold rounded-lg transition-all flex items-center justify-center gap-2"
            >
              {resending ? (
                <>
                  <Loader2 size={20} className="animate-spin" />
            ...
            <button
              ...
              className="w-full py-3 text-gray-400 hover:text-white font-semibold rounded-lg transition-all flex items-center justify-center gap-2"
            >
              <ArrowLeft size={20} />
              Back to Login
            </button>
